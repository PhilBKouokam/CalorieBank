...
- The smallest banking slice is source-attributed intake/expenditure sync -> immediate provisional contribution -> immutable ledger deposit or withdrawal -> two-day correction window -> permanent lock, as governed by ADR 009.

...
- Resolve exactly one authoritative expenditure provider and one authoritative intake provider for every bank calculation. Never sum Fitbit and Apple Health expenditure or multiple intake providers. Provider changes may reconcile provisional days with append-only deltas; locked days remain unchanged.

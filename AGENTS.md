...
- Do not equate V1 scope with first-use visibility. Keep the initial experience focused on Available Bank, latest finalized contribution, calculation explanation, and required data status; follow ADR 011 before exposing optional capabilities by default or adding recommendation behavior.

...
public class HealthConnectRationaleActivity extends Activity {
  @Override public void onCreate(Bundle state) {
    ...
    text.setText("CalorieBank — Health Connect access\\n\\n${mod.extra?.healthConnectQualification === true ? "CalorieBank's Android qualification tool reads calories eaten, steps, exercise sessions, distance, active and total calories burned, and resting metabolic rate. It checks source identity and recent history to determine which data can safely support CalorieBank." : "CalorieBank reads nutrition from the food tracker you select in Health Connect, including recent history, to show calories eaten and calculate your calorie bank with your selected burn source."}\\n\\nWhen you select a food tracker, CalorieBank uploads only its normalized daily calorie totals and exact source identity to your account. The server uses completed-day totals with your selected burn source to update your bank. ${mod.extra?.healthConnectQualification === true ? "Activity and burn records remain qualification evidence only. Diagnostics display counts, source packages and quality states, not raw health records." : "Fitbit supplies calories burned and activity separately; CalorieBank does not request Health Connect activity or burn access in this build."} CalorieBank never writes to Health Connect.\\n\\nYou control access in Health Connect settings and can revoke any permission. No background access or unrelated health categories are requested.");
    text.setTextSize(18);
